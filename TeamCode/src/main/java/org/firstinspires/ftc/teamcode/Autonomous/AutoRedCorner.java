...
public class AutoRedCorner extends MechBaseAutoOp {
    ...
    public void initSteps(){
        ...
        steps.add(new Step(-20, -0.1 , -0.1, JKMOVE, 0, RED));
        steps.add(new Step(0, 0.05, 0.05, LEFT, 26, RED));
        //steps.add(new Step(-12, -0.1 , -0.1, VUMOVE, 0, RED));
        //steps.add(new Step(0, -0.05 , -0.05, RIGHT, 90, RED));
        steps.add(new Step(-5, -0.1 , -0.1, MOVE, 0, RED));
        steps.add(new Step(0, -0.1 , -0.1, DROPBLOCK, 0, RED));
        steps.add(new Step(5, 0.1 , 0.1, MOVE, 0, RED));
        steps.add(new Step(-8, -0.1 , -0.1, MOVE, 0, RED));
