...
public class AutoRedCorner extends MechBaseAutoOp {
    ...
    public void initSteps(){
        ...
        steps.add(new Step(-19, -0.1 , -0.1, StepType.MOVE, 0, RED));
        steps.add(new Step(0, 0.05, 0.05, StepType.LEFT, 90, RED));
        steps.add(new Step(0, -0.1, -0.1, StepType.VUMOVE, 40, RED));
        ...
        steps.add(new Step(2, 0.1 , 0.1, StepType.MOVE, 0, RED));
    }
}
